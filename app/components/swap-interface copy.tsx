...
// //                     className="rounded-lg border border-neutral-800 bg-black/40 px-3 py-2 text-sm text-white placeholder-white/40 outline-none focus:border-white/25"
// //                   />
// //                 </div>
// //                 <div className="flex flex-col gap-1">
...
// //               </div>
// //               <div className="mt-3 text-xs text-white/60">
// //                 Orders will attempt to execute when the market crosses your limit
// //                 price.
// //               </div>
// //             </div>
// //           )}
...
//  NEW SWAP INTERFACE (28 april 2026)
